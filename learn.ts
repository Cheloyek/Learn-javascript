...
let d:string // задаем тип переменной, значение будет присвоено позже

let g: Array<number> // тип массив чисел

let n: Array<string | number> // тип массив строк или чисел
